...
const person3 = {title:"Ms",firstname:"Laura", surname:"Jimenez", mobile:6572822, email:"laura@gmail.com", address_line_1:"34 Paul", address_line_2:"Court", town:"Mullingar", county:"WestMeath", eircode:"7823 G2F4"};
...
// RETRIEVING DATA 
const person_to_retrieve = {firstname: "John", surname:"Doe"};
...
// UPDATING DATA 
const person_to_update = {firstname: person2.firstname, surname:person2.surname};
var new_title = "Mx";
var new_email = "EricaNew@gmail.com";
...
var update_user_home_address_sql = `UPDATE user_home_address SET address_line_1 = '${new_address_line_1}' WHERE first_name = '${person_to_update.firstname}' and surname ='${person_to_update.surname}'`;
var update_user_shipping_address_sql = `UPDATE user_shipping_address SET address_line_1 = '${new_address_line_1}' WHERE first_name = '${person_to_update.firstname}' and surname ='${person_to_update.surname}'`;
...
// DELETING DATA
const person_to_delete = {firstname: "Mark", surname:"Jimenez", email:"markJ@gmail.com", mobile: 562229};
